...
alert("You will be converting an empty room in your house to an indoor garden. To do so, you must consider how much space wll be devoted to a walkway and how much space will be devoted to the garden area.");
...
function calculateRoom(width, length){
	return width*length
};
function calculateWalk(walkWidth, walkLength){
	return walkWidth*walkLength
};
function differenceArea(roomArea, walkArea){
